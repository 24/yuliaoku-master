...
package com.xya.UserInterface.MaterialWidget.Widget;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.drawable_tab_style;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        // get color_system attrs (android:textSize and android:textColor)
